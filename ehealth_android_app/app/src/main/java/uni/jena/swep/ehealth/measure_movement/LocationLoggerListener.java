...
public class LocationLoggerListener implements LocationListener {
    ...
    public void printData(){
        ...
        //Log.v("tracking", "Positions in db:");
        for(LocationEntity l:dao.getItems()){
            //System.out.println(l);
            //Log.v("tracking", l.getLatitude() + " | " + l.getLongitude());
        }
    ...
    public void startListeningLocations(Context context) {
        myContext=context;
        ...
        // TODO check if best provider is chosen on every device
